...
import { syncUserNameAction } from "./actions/user-actions.server";
import { updateDisplayNameAction } from "./settings-actions.server";
import { updateBioAction } from "./profile-actions.server";
            ...
            <div className="max-w-7xl mx-auto glass-panel rounded-xl p-6 md:p-10 space-y-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <aside className="lg:col-span-1 space-y-6">
                        ...
                        <div className="glass-card rounded-xl p-1 border-primary/10 mt-6">
                            <div className="p-6 space-y-6">
                                <div>
                                    <h3 className="font-semibold leading-none tracking-tight mb-4">Public Profile</h3>
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <form action={async (formData) => {
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full px-3 py-2 rounded-md border border-white/10 bg-white/5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 min-h-[100px]"
                                        ...
                                        {/* Profile Visibility - Moved to Privacy Settings */}
                      ...
                      <Button variant="outline" size="sm" asChild>
                        <a href="/settings/privacy">Manage</a>
                      </Button>
                    </div> */}
                                    </div>
                                </div>
